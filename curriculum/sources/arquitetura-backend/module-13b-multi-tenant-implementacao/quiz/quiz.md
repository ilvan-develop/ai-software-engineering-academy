# Quiz — Módulo 13b — Multi-Tenant: Implementação com NestJS e Prisma
...
Qual é o conceito principal abordado em "Módulo 13b — Multi-Tenant: Implementação com NestJS e Prisma"?

- [ ] A) 3.4 Prisma Extension (Prisma >= 5.0)
- [ ] B) 1. Identificação do Tenant
- [ ] C) 1.1 Estratégias de Identificação
- [ ] D) 1.2 Subdomínio

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Identificação do Tenant", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "1.1 Estratégias de Identificação" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "1.1 Estratégias de Identificação" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar 1.2 Subdomínio, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Identificação do Tenant" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "13b - Multi-Tenant: Implementação com NestJS e Prisma" e assinale a alternativa que contém APENAS afirmações corretas:
