# Exercícios — Módulo 13b — Multi-Tenant: Implementação com NestJS e Prisma

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '13b - Multi-Tenant: Implementação com NestJS e Prisma' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Identificação do Tenant. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza 1.1 Estratégias de Identificação. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '13b - Multi-Tenant: Implementação com NestJS e Prisma'

**Cenário:**
Você foi contratado para resolver um problema real usando 1.2 Subdomínio. O cliente espera uma solução bem documentada e testada.
