# Projeto Pratico — Módulo 13b — Multi-Tenant: Implementação com NestJS e Prisma

---

## Visao Geral

**Tema:** Módulo 13b - Multi-Tenant: Implementação com NestJS e Prisma
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 13b - Multi-Tenant: Implementação com NestJS e Prisma**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. Identificação do Tenant
...
```
projeto-módulo-13b---multi-tenant:-implementação-com-nestjs-e-prisma/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. Identificação do Tenant corretamente | Implementa mas com falhas | Implementacao robusta e completa |
