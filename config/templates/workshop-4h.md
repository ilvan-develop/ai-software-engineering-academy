============================================================
WORKSHOP: Módulo 08 - Arquitetura: Clean Architecture, DDD e SOLID
============================================================

**Duracao:** 4h
**Formato:** Presencial / Online
**Publico-alvo:** Desenvolvedores, arquitetos, tech leads
**Pre-requisitos:** Conhecimento basico em desenvolvimento de software
...
- Compreender e aplicar conceitos de **Módulo 08 - Arquitetura: Clean Architecture, DDD e SOLID**
- Compreender e aplicar conceitos de **Módulo 09 - Modelagem de Dados: Prisma e PostgreSQL**
- Compreender e aplicar conceitos de **Módulo 10 - Backend: APIs Enterprise com NestJS**
...
| Atividade | Duracao |
|-----------|---------|
| Abertura e Contextualizacao | 15 min |
| Parte 1 - Teoria | 45 min |
| Dinamica 1 | 30 min |
| Intervalo | 15 min |
| Parte 2 - Pratica | 60 min |
| Dinamica 2 | 45 min |
| Encerramento e Q&A | 30 min |
...
### Bloco 1: Abertura e Contextualizacao (15min)
...
### Bloco 2: Parte 1 - Teoria (45min)

**Objetivo:** Apresentar os fundamentos teoricos

**Roteiro:**
1. 1. Por que arquitetura importa (15min)
2. 2. SOLID — Os 5 princípios (15min)
3. 3. Clean Architecture — A Regra da Dependência (15min)
4. 4. DDD — Domain-Driven Design (15min)

**Tecnica:** Exposicao dialogada com slides + perguntas

---

### Bloco 3: Dinamica 1 (30min)
...
### Bloco 4: Intervalo (15min)

**Pausa para descanso e networking.**

---

### Bloco 5: Parte 2 - Pratica (60min)
...
### Bloco 7: Encerramento e Q&A (30min)
...
- Documentacao oficial dos topicos abordados
- Artigos complementares sobre Módulo 08 - Arquitetura: Clean Architecture, DDD e SOLID
