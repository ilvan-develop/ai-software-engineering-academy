# Projeto Pratico — Módulo 00 — Introdução: A Nova Engenharia de Software

---

## Visao Geral

**Tema:** Módulo 00 - Introdução: A Nova Engenharia de Software
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 00 - Introdução: A Nova Engenharia de Software**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. Como a IA mudou o desenvolvimento de software
...
```
projeto-módulo-00---introdução:-a-nova-engenharia-de-software/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. Como a IA mudou o desenvolvimento de software corretamente | Implementa mas com falhas | Implementacao robusta e completa |
