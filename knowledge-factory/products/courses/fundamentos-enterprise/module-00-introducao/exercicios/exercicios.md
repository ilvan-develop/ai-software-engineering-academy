# Exercícios — Módulo 00 — Introdução: A Nova Engenharia de Software

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '00 - Introdução: A Nova Engenharia de Software' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Como a IA mudou o desenvolvimento de software. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza O cenário antes da IA. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '00 - Introdução: A Nova Engenharia de Software'

**Cenário:**
Você foi contratado para resolver um problema real usando O cenário com IA. O cliente espera uma solução bem documentada e testada.
