# Quiz — Módulo 00 — Introdução: A Nova Engenharia de Software
...
Qual é o conceito principal abordado em "Módulo 00 — Introdução: A Nova Engenharia de Software"?

- [ ] A) Resumo
- [ ] B) 1. Como a IA mudou o desenvolvimento de software
- [ ] C) O cenário antes da IA
- [ ] D) O cenário com IA

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Como a IA mudou o desenvolvimento de software", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "O cenário antes da IA" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "O cenário antes da IA" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar O cenário com IA, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Como a IA mudou o desenvolvimento de software" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "00 - Introdução: A Nova Engenharia de Software" e assinale a alternativa que contém APENAS afirmações corretas:
