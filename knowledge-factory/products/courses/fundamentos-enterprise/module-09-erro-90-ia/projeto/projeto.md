# Projeto Pratico — O erro que 90% das pessoas cometem usando IA para programar

---

## Visao Geral

**Tema:** O erro que 90% das pessoas cometem usando IA para programar
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **O erro que 90% das pessoas cometem usando IA para programar**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de Pré-requisitos
...
```
projeto-o-erro-que-90%-das-pessoas-cometem-usando-ia-para-programar/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa Pré-requisitos corretamente | Implementa mas com falhas | Implementacao robusta e completa |
