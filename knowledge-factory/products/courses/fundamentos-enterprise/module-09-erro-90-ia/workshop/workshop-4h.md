...
- Compreender e aplicar conceitos de **O erro que 90% das pessoas cometem usando IA para programar**
...
**Roteiro:**
1. Pré-requisitos (15min)
2. Objetivos de aprendizagem (15min)
3. Competências desenvolvidas (15min)
4. 1. Introdução: por que 90% cometem esse erro (15min)
...
- Artigos complementares sobre O erro que 90% das pessoas cometem usando IA para programar
