# Exercícios — Módulo 01 — Mentalidade Enterprise

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '01 - Mentalidade Enterprise' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é software Enterprise?. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Características. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '01 - Mentalidade Enterprise'

**Cenário:**
Você foi contratado para resolver um problema real usando Diferença entre software de consumo e Enterprise. O cliente espera uma solução bem documentada e testada.
