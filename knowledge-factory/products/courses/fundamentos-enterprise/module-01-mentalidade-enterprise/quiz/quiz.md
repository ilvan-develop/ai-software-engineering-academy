# Quiz — Módulo 01 — Mentalidade Enterprise
...
Qual é o conceito principal abordado em "Módulo 01 — Mentalidade Enterprise"?

- [ ] A) Alta disponibilidade — sem ponto único de falha
- [ ] B) 1. O que é software Enterprise?
- [ ] C) Características
- [ ] D) Diferença entre software de consumo e Enterprise

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é software Enterprise?", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Características" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Características" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Diferença entre software de consumo e Enterprise, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é software Enterprise?" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "01 - Mentalidade Enterprise" e assinale a alternativa que contém APENAS afirmações corretas:
