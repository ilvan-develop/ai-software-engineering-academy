# Quiz — Módulo 21 — Projeto Final: Enterprise SaaS de Gestão de Projetos e Tarefas
...
Qual é o conceito principal abordado em "Módulo 21 — Projeto Final: Enterprise SaaS de Gestão de Projetos e Tarefas"?

- [ ] A) Resumo
- [ ] B) 1. Visão Geral do Projeto
- [ ] C) 1.1 Objetivo
- [ ] D) 1.2 O que será construído

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Visão Geral do Projeto", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "1.1 Objetivo" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "1.1 Objetivo" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar 1.2 O que será construído, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Visão Geral do Projeto" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "21 - Projeto Final: Enterprise SaaS de Gestão de Projetos e Tarefas" e assinale a alternativa que contém APENAS afirmações corretas:
