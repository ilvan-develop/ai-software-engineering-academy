# Exercícios — Módulo 21 — Projeto Final: Enterprise SaaS de Gestão de Projetos e Tarefas

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '21 - Projeto Final: Enterprise SaaS de Gestão de Projetos e Tarefas' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Visão Geral do Projeto. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza 1.1 Objetivo. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '21 - Projeto Final: Enterprise SaaS de Gestão de Projetos e Tarefas'

**Cenário:**
Você foi contratado para resolver um problema real usando 1.2 O que será construído. O cliente espera uma solução bem documentada e testada.
