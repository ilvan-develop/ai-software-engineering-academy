# Quiz — Módulo 03 — Design Thinking: Inovação Centrada no Usuário
...
Qual é o conceito principal abordado em "Módulo 03 — Design Thinking: Inovação Centrada no Usuário"?

- [ ] A) Anti-padrões incluem pular empatia, prototipar cedo demais e testar com amigos
- [ ] B) 1. O que é Design Thinking
- [ ] C) Origem
- [ ] D) Mindset do Design Thinking

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é Design Thinking", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Origem" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Origem" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Mindset do Design Thinking, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é Design Thinking" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "03 - Design Thinking: Inovação Centrada no Usuário" e assinale a alternativa que contém APENAS afirmações corretas:
