# Exercícios — Módulo 03 — Design Thinking: Inovação Centrada no Usuário

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '03 - Design Thinking: Inovação Centrada no Usuário' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é Design Thinking. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Origem. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '03 - Design Thinking: Inovação Centrada no Usuário'

**Cenário:**
Você foi contratado para resolver um problema real usando Mindset do Design Thinking. O cliente espera uma solução bem documentada e testada.
