# Projeto Pratico — Módulo 03 — Design Thinking: Inovação Centrada no Usuário

---

## Visao Geral

**Tema:** Módulo 03 - Design Thinking: Inovação Centrada no Usuário
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 03 - Design Thinking: Inovação Centrada no Usuário**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que é Design Thinking
...
```
projeto-módulo-03---design-thinking:-inovação-centrada-no-usuário/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que é Design Thinking corretamente | Implementa mas com falhas | Implementacao robusta e completa |
