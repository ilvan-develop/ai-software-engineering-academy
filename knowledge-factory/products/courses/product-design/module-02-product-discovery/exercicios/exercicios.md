# Exercícios — Módulo 02 — Product Discovery: Validando Ideias Antes de Construir

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '02 - Product Discovery: Validando Ideias Antes de Construir' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é Product Discovery?. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Discovery vs Delivery. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '02 - Product Discovery: Validando Ideias Antes de Construir'

**Cenário:**
Você foi contratado para resolver um problema real usando Por que Discovery é importante?. O cliente espera uma solução bem documentada e testada.
