# Projeto Pratico — Módulo 02 — Product Discovery: Validando Ideias Antes de Construir

---

## Visao Geral

**Tema:** Módulo 02 - Product Discovery: Validando Ideias Antes de Construir
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 02 - Product Discovery: Validando Ideias Antes de Construir**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que é Product Discovery?
...
```
projeto-módulo-02---product-discovery:-validando-ideias-antes-de-construir/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que é Product Discovery? corretamente | Implementa mas com falhas | Implementacao robusta e completa |
