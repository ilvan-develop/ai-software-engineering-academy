# Quiz — Módulo 02 — Product Discovery: Validando Ideias Antes de Construir
...
Qual é o conceito principal abordado em "Módulo 02 — Product Discovery: Validando Ideias Antes de Construir"?

- [ ] A) Saídas: backlog refinado, proto-personas, user stories, opportunity backlog
- [ ] B) 1. O que é Product Discovery?
- [ ] C) Discovery vs Delivery
- [ ] D) Por que Discovery é importante?

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é Product Discovery?", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Discovery vs Delivery" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Discovery vs Delivery" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Por que Discovery é importante?, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é Product Discovery?" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "02 - Product Discovery: Validando Ideias Antes de Construir" e assinale a alternativa que contém APENAS afirmações corretas:
