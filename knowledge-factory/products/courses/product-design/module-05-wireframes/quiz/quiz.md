...
Qual é o conceito principal abordado em "Módulo 05 — Wireframes"?

- [ ] A) Enterprise: documentação, versionamento, handoff, aprovações
- [ ] B) 1. O que são Wireframes
- [ ] C) Propósito
- [ ] D) Níveis de Fidelidade

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que são Wireframes", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Propósito" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Propósito" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Níveis de Fidelidade, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que são Wireframes" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "05 - Wireframes" e assinale a alternativa que contém APENAS afirmações corretas:
