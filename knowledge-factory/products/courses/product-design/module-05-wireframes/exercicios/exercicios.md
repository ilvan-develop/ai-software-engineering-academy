# Exercícios — Módulo 05 — Wireframes

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '05 - Wireframes' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que são Wireframes. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Propósito. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '05 - Wireframes'

**Cenário:**
Você foi contratado para resolver um problema real usando Níveis de Fidelidade. O cliente espera uma solução bem documentada e testada.
