# Projeto Pratico — Módulo 05 — Wireframes

---

## Visao Geral

**Tema:** Módulo 05 - Wireframes
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 05 - Wireframes**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que são Wireframes
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que são Wireframes corretamente | Implementa mas com falhas | Implementacao robusta e completa |
