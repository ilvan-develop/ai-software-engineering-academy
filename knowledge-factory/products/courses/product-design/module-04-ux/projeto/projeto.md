# Projeto Pratico — Módulo 04 — UX: Experiência do Usuário

---

## Visao Geral

**Tema:** Módulo 04 - UX: Experiência do Usuário
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 04 - UX: Experiência do Usuário**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que é UX?
...
```
projeto-módulo-04---ux:-experiência-do-usuário/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que é UX? corretamente | Implementa mas com falhas | Implementacao robusta e completa |
