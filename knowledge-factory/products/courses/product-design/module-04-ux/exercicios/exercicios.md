# Exercícios — Módulo 04 — UX: Experiência do Usuário

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '04 - UX: Experiência do Usuário' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é UX?. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza UX vs UI. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '04 - UX: Experiência do Usuário'

**Cenário:**
Você foi contratado para resolver um problema real usando Os 5 Planos de Jesse James Garrett. O cliente espera uma solução bem documentada e testada.
