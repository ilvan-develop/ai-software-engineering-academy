# Quiz — Módulo 04 — UX: Experiência do Usuário
...
Qual é o conceito principal abordado em "Módulo 04 — UX: Experiência do Usuário"?

- [ ] A) Resumo
- [ ] B) 1. O que é UX?
- [ ] C) UX vs UI
- [ ] D) Os 5 Planos de Jesse James Garrett

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é UX?", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "UX vs UI" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "UX vs UI" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Os 5 Planos de Jesse James Garrett, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é UX?" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "04 - UX: Experiência do Usuário" e assinale a alternativa que contém APENAS afirmações corretas:
