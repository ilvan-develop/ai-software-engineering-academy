# Exercícios — Módulo 06 — UI Design

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '06 - UI Design' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é UI Design. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza UI ≠ UX. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '06 - UI Design'

**Cenário:**
Você foi contratado para resolver um problema real usando A relação UI + UX. O cliente espera uma solução bem documentada e testada.
