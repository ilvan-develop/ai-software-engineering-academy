...
Qual é o conceito principal abordado em "Módulo 06 — UI Design"?

- [ ] A) UI para devs: inspeção no Figma, fidelidade, densidade, estados
- [ ] B) 1. O que é UI Design
- [ ] C) UI ≠ UX
- [ ] D) A relação UI + UX

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é UI Design", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "UI ≠ UX" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "UI ≠ UX" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar A relação UI + UX, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é UI Design" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "06 - UI Design" e assinale a alternativa que contém APENAS afirmações corretas:
