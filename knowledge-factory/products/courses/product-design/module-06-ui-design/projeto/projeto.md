# Projeto Pratico — Módulo 06 — UI Design

---

## Visao Geral

**Tema:** Módulo 06 - UI Design
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 06 - UI Design**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que é UI Design
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que é UI Design corretamente | Implementa mas com falhas | Implementacao robusta e completa |
