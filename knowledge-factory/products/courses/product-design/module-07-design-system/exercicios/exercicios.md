# Exercícios — Módulo 07 — Design System: Consistência em Escala

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '07 - Design System: Consistência em Escala' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é Design System. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Design System vs Style Guide vs Component Library. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '07 - Design System: Consistência em Escala'

**Cenário:**
Você foi contratado para resolver um problema real usando Propósito. O cliente espera uma solução bem documentada e testada.
