# Quiz — Módulo 07 — Design System: Consistência em Escala
...
Qual é o conceito principal abordado em "Módulo 07 — Design System: Consistência em Escala"?

- [ ] A) Implementação prática: React + TypeScript + Storybook + tokens CSS
- [ ] B) 1. O que é Design System
- [ ] C) Design System vs Style Guide vs Component Library
- [ ] D) Propósito

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é Design System", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Design System vs Style Guide vs Component Library" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Design System vs Style Guide vs Component Library" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Propósito, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é Design System" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "07 - Design System: Consistência em Escala" e assinale a alternativa que contém APENAS afirmações corretas:
