# Projeto Pratico — Módulo 07 — Design System: Consistência em Escala

---

## Visao Geral

**Tema:** Módulo 07 - Design System: Consistência em Escala
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 07 - Design System: Consistência em Escala**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que é Design System
...
```
projeto-módulo-07---design-system:-consistência-em-escala/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que é Design System corretamente | Implementa mas com falhas | Implementacao robusta e completa |
