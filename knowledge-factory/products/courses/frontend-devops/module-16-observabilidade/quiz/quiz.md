# Quiz — Módulo 16 — Observabilidade: Logs, Métricas e Tracing
...
Qual é o conceito principal abordado em "Módulo 16 — Observabilidade: Logs, Métricas e Tracing"?

- [ ] A) Centralização — Loki + Grafana para logs searcháveis
- [ ] B) 1. O que é observabilidade?
- [ ] C) Os 3 pilares
- [ ] D) Sem observabilidade

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é observabilidade?", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Os 3 pilares" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Os 3 pilares" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Sem observabilidade, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é observabilidade?" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "16 - Observabilidade: Logs, Métricas e Tracing" e assinale a alternativa que contém APENAS afirmações corretas:
