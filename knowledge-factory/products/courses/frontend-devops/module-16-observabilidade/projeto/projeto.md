# Projeto Pratico — Módulo 16 — Observabilidade: Logs, Métricas e Tracing

---

## Visao Geral

**Tema:** Módulo 16 - Observabilidade: Logs, Métricas e Tracing
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 16 - Observabilidade: Logs, Métricas e Tracing**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que é observabilidade?
...
```
projeto-módulo-16---observabilidade:-logs,-métricas-e-tracing/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que é observabilidade? corretamente | Implementa mas com falhas | Implementacao robusta e completa |
