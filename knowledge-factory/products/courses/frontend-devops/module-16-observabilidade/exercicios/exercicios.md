# Exercícios — Módulo 16 — Observabilidade: Logs, Métricas e Tracing

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '16 - Observabilidade: Logs, Métricas e Tracing' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é observabilidade?. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Os 3 pilares. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '16 - Observabilidade: Logs, Métricas e Tracing'

**Cenário:**
Você foi contratado para resolver um problema real usando Sem observabilidade. O cliente espera uma solução bem documentada e testada.
