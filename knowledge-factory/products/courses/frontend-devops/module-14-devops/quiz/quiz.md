# Quiz — Módulo 14 — DevOps: Docker, CI/CD e Deploy
...
Qual é o conceito principal abordado em "Módulo 14 — DevOps: Docker, CI/CD e Deploy"?

- [ ] A) Logs estruturados — JSON para ferramentas de observabilidade
- [ ] B) 1. Por que DevOps importa
- [ ] C) O problema clássico
- [ ] D) A solução DevOps

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Por que DevOps importa", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "O problema clássico" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "O problema clássico" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar A solução DevOps, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Por que DevOps importa" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "14 - DevOps: Docker, CI/CD e Deploy" e assinale a alternativa que contém APENAS afirmações corretas:
