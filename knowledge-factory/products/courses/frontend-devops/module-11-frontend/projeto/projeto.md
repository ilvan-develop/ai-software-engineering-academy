# Projeto Pratico — Módulo 11 — Frontend: Interfaces Enterprise com Next.js

---

## Visao Geral

**Tema:** Módulo 11 - Frontend: Interfaces Enterprise com Next.js
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 11 - Frontend: Interfaces Enterprise com Next.js**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. Next.js App Router — A Nova Forma de Pensar
...
```
projeto-módulo-11---frontend:-interfaces-enterprise-com-next.js/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. Next.js App Router — A Nova Forma de Pensar corretamente | Implementa mas com falhas | Implementacao robusta e completa |
