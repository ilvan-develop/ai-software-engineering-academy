# Quiz — Módulo 11 — Frontend: Interfaces Enterprise com Next.js
...
Qual é o conceito principal abordado em "Módulo 11 — Frontend: Interfaces Enterprise com Next.js"?

- [ ] A) Performance — next/image, next/font, dynamic import
- [ ] B) 1. Next.js App Router — A Nova Forma de Pensar
- [ ] C) Server Components vs Client Components
- [ ] D) Regra de ouro

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Next.js App Router — A Nova Forma de Pensar", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Server Components vs Client Components" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Server Components vs Client Components" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Regra de ouro, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Next.js App Router — A Nova Forma de Pensar" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "11 - Frontend: Interfaces Enterprise com Next.js" e assinale a alternativa que contém APENAS afirmações corretas:
