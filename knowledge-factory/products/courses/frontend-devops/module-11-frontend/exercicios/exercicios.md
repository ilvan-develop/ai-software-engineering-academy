# Exercícios — Módulo 11 — Frontend: Interfaces Enterprise com Next.js

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '11 - Frontend: Interfaces Enterprise com Next.js' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Next.js App Router — A Nova Forma de Pensar. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Server Components vs Client Components. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '11 - Frontend: Interfaces Enterprise com Next.js'

**Cenário:**
Você foi contratado para resolver um problema real usando Regra de ouro. O cliente espera uma solução bem documentada e testada.
