============================================================
WORKSHOP: Módulo 11 - Frontend: Interfaces Enterprise com Next.js
============================================================
...
- Compreender e aplicar conceitos de **Módulo 11 - Frontend: Interfaces Enterprise com Next.js**
...
**Roteiro:**
1. 1. Next.js App Router — A Nova Forma de Pensar (15min)
2. 2. Data Fetching — Buscando Dados (15min)
3. 3. Loading, Error e Empty States (15min)
4. 4. Formulários com Server Actions (15min)
...
- Artigos complementares sobre Módulo 11 - Frontend: Interfaces Enterprise com Next.js
