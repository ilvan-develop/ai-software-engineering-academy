# Quiz — Módulo 15 — QA: Testes e Qualidade
...
Qual é o conceito principal abordado em "Módulo 15 — QA: Testes e Qualidade"?

- [ ] A) TDD — Red → Green → Refactor
- [ ] B) 1. Por que testar?
- [ ] C) O custo de não testar
- [ ] D) A pirâmide de testes

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Por que testar?", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "O custo de não testar" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "O custo de não testar" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar A pirâmide de testes, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Por que testar?" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "15 - QA: Testes e Qualidade" e assinale a alternativa que contém APENAS afirmações corretas:
