# Projeto Pratico — Módulo 15 — QA: Testes e Qualidade

---

## Visao Geral

**Tema:** Módulo 15 - QA: Testes e Qualidade
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 15 - QA: Testes e Qualidade**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. Por que testar?
...
```
projeto-módulo-15---qa:-testes-e-qualidade/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. Por que testar? corretamente | Implementa mas com falhas | Implementacao robusta e completa |
