# Exercícios — Módulo 15 — QA: Testes e Qualidade

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '15 - QA: Testes e Qualidade' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Por que testar?. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza O custo de não testar. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '15 - QA: Testes e Qualidade'

**Cenário:**
Você foi contratado para resolver um problema real usando A pirâmide de testes. O cliente espera uma solução bem documentada e testada.
