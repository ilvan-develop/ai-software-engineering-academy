# Exercícios — Módulo 09 — Modelagem de Dados: Prisma e PostgreSQL

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '09 - Modelagem de Dados: Prisma e PostgreSQL' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Por que modelagem importa. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza O custo de uma modelagem ruim. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '09 - Modelagem de Dados: Prisma e PostgreSQL'

**Cenário:**
Você foi contratado para resolver um problema real usando 2. Entidades e Relacionamentos. O cliente espera uma solução bem documentada e testada.
