# Quiz — Módulo 09 — Modelagem de Dados: Prisma e PostgreSQL
...
Qual é o conceito principal abordado em "Módulo 09 — Modelagem de Dados: Prisma e PostgreSQL"?

- [ ] A) Backup — full + incremental + WAL; testar restore periodicamente
- [ ] B) 1. Por que modelagem importa
- [ ] C) O custo de uma modelagem ruim
- [ ] D) 2. Entidades e Relacionamentos

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Por que modelagem importa", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "O custo de uma modelagem ruim" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "O custo de uma modelagem ruim" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar 2. Entidades e Relacionamentos, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Por que modelagem importa" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "09 - Modelagem de Dados: Prisma e PostgreSQL" e assinale a alternativa que contém APENAS afirmações corretas:
