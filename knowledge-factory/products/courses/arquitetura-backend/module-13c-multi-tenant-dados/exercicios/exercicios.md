# Exercícios — Módulo 13c — Multi-Tenant: Migrations, Dados e Seed

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '13c - Multi-Tenant: Migrations, Dados e Seed' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Migrations Multi-Tenant. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Tema:** Implementar uma solução completa usando os conceitos de '13c - Multi-Tenant: Migrations, Dados e Seed'

**Cenário:**
Você foi contratado para resolver um problema real usando 1.2 Schema per Tenant. O cliente espera uma solução bem documentada e testada.
