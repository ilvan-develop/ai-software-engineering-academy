# Quiz — Módulo 13c — Multi-Tenant: Migrations, Dados e Seed
...
Qual é o conceito principal abordado em "Módulo 13c — Multi-Tenant: Migrations, Dados e Seed"?

- [ ] A) 3.3 Idempotência
- [ ] B) 1. Migrations Multi-Tenant
- [ ] C) 1.1 Database per Tenant
- [ ] D) 1.2 Schema per Tenant

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Migrations Multi-Tenant", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "1.1 Database per Tenant" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "1.1 Database per Tenant" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar 1.2 Schema per Tenant, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Migrations Multi-Tenant" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "13c - Multi-Tenant: Migrations, Dados e Seed" e assinale a alternativa que contém APENAS afirmações corretas:
