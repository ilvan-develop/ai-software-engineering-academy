# Quiz — Módulo 13 — Multi-Tenant: Construindo SaaS Escalável
...
Qual é o conceito principal abordado em "Módulo 13 — Multi-Tenant: Construindo SaaS Escalável"?

- [ ] A) Testes: vazamento zero, concorrência, injeção de tenant_id, rate limit, e teste de quebra proposital
- [ ] B) 1. O que é Multi-Tenancy?
- [ ] C) 1.1 Conceito
- [ ] D) 1.2 Por que usar?

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é Multi-Tenancy?", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "1.1 Conceito" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "1.1 Conceito" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar 1.2 Por que usar?, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é Multi-Tenancy?" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "13 - Multi-Tenant: Construindo SaaS Escalável" e assinale a alternativa que contém APENAS afirmações corretas:
