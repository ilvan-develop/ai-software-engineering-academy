# Projeto Pratico — Módulo 13 — Multi-Tenant: Conceitos e Estratégias de Isolamento

---

## Visao Geral

**Tema:** Módulo 13 - Multi-Tenant: Conceitos e Estratégias de Isolamento
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 13 - Multi-Tenant: Conceitos e Estratégias de Isolamento**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que é Multi-Tenancy?
...
```
projeto-módulo-13---multi-tenant:-conceitos-e-estratégias-de-isolamento/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que é Multi-Tenancy? corretamente | Implementa mas com falhas | Implementacao robusta e completa |
