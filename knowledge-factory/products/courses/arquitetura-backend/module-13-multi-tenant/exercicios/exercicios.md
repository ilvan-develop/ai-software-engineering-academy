# Exercícios — Módulo 13 — Multi-Tenant: Construindo SaaS Escalável

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '13 - Multi-Tenant: Construindo SaaS Escalável' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é Multi-Tenancy?. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza 1.1 Conceito. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '13 - Multi-Tenant: Construindo SaaS Escalável'

**Cenário:**
Você foi contratado para resolver um problema real usando 1.2 Por que usar?. O cliente espera uma solução bem documentada e testada.
