# Exercícios — Módulo 12 — Segurança

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '12 - Segurança' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Por que segurança é o requisito mais importante. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza O custo de uma falha de segurança. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '12 - Segurança'

**Cenário:**
Você foi contratado para resolver um problema real usando Mindset de segurança. O cliente espera uma solução bem documentada e testada.
