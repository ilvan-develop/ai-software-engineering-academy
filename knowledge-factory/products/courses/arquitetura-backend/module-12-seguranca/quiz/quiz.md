...
Qual é o conceito principal abordado em "Módulo 12 — Segurança"?

- [ ] A) Auditoria — logs de ações sensíveis para rastreabilidade
- [ ] B) 1. Por que segurança é o requisito mais importante
- [ ] C) O custo de uma falha de segurança
- [ ] D) Mindset de segurança

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Por que segurança é o requisito mais importante", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "O custo de uma falha de segurança" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "O custo de uma falha de segurança" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Mindset de segurança, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Por que segurança é o requisito mais importante" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "12 - Segurança" e assinale a alternativa que contém APENAS afirmações corretas:
