# Exercícios — Módulo 13d — Multi-Tenant: Operações e Qualidade

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '13d - Multi-Tenant: Operações e Qualidade' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Backup e Restore. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza 1.1 Database per Tenant. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '13d - Multi-Tenant: Operações e Qualidade'

**Cenário:**
Você foi contratado para resolver um problema real usando 1.2 Schema per Tenant — Backup Seletivo. O cliente espera uma solução bem documentada e testada.
