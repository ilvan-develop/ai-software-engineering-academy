# Quiz — Módulo 10 — Backend: APIs Enterprise com NestJS
...
Qual é o conceito principal abordado em "Módulo 10 — Backend: APIs Enterprise com NestJS"?

- [ ] A) Testes — unitários + integração com mocks
- [ ] B) 1. Por que NestJS?
- [ ] C) Comparação
- [ ] D) Módulo NestJS típico

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Por que NestJS?", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Comparação" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Comparação" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Módulo NestJS típico, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Por que NestJS?" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "10 - Backend: APIs Enterprise com NestJS" e assinale a alternativa que contém APENAS afirmações corretas:
