# Exercícios — Módulo 10 — Backend: APIs Enterprise com NestJS

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '10 - Backend: APIs Enterprise com NestJS' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Por que NestJS?. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Comparação. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '10 - Backend: APIs Enterprise com NestJS'

**Cenário:**
Você foi contratado para resolver um problema real usando Módulo NestJS típico. O cliente espera uma solução bem documentada e testada.
