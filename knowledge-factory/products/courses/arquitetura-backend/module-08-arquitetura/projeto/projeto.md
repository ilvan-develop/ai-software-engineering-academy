# Projeto Pratico — Módulo 08 — Arquitetura: Clean Architecture, DDD e SOLID

---

## Visao Geral

**Tema:** Módulo 08 - Arquitetura: Clean Architecture, DDD e SOLID
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 08 - Arquitetura: Clean Architecture, DDD e SOLID**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. Por que arquitetura importa
...
```
projeto-módulo-08---arquitetura:-clean-architecture,-ddd-e-solid/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. Por que arquitetura importa corretamente | Implementa mas com falhas | Implementacao robusta e completa |
