# Quiz — Módulo 08 — Arquitetura: Clean Architecture, DDD e SOLID
...
Qual é o conceito principal abordado em "Módulo 08 — Arquitetura: Clean Architecture, DDD e SOLID"?

- [ ] A) Prática com NestJS — a estrutura de pastas reflete a arquitetura
- [ ] B) 1. Por que arquitetura importa
- [ ] C) O custo de uma arquitetura ruim
- [ ] D) O que arquitetura define

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Por que arquitetura importa", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "O custo de uma arquitetura ruim" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "O custo de uma arquitetura ruim" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar O que arquitetura define, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Por que arquitetura importa" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "08 - Arquitetura: Clean Architecture, DDD e SOLID" e assinale a alternativa que contém APENAS afirmações corretas:
