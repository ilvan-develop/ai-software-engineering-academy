# Exercícios — Módulo 08 — Arquitetura: Clean Architecture, DDD e SOLID

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '08 - Arquitetura: Clean Architecture, DDD e SOLID' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Por que arquitetura importa. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza O custo de uma arquitetura ruim. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '08 - Arquitetura: Clean Architecture, DDD e SOLID'

**Cenário:**
Você foi contratado para resolver um problema real usando O que arquitetura define. O cliente espera uma solução bem documentada e testada.
