# Exercícios — Módulo 17 — Governança

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '17 - Governança' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é Governança de TI. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Por que governança importa. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '17 - Governança'

**Cenário:**
Você foi contratado para resolver um problema real usando Frameworks de Governança. O cliente espera uma solução bem documentada e testada.
