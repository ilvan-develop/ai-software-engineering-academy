...
Qual é o conceito principal abordado em "Módulo 17 — Governança"?

- [ ] A) Resumo
- [ ] B) 1. O que é Governança de TI
- [ ] C) Por que governança importa
- [ ] D) Frameworks de Governança

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é Governança de TI", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Por que governança importa" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Por que governança importa" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Frameworks de Governança, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é Governança de TI" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "17 - Governança" e assinale a alternativa que contém APENAS afirmações corretas:
