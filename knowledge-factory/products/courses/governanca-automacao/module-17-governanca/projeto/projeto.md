# Projeto Pratico — Módulo 17 — Governança

---

## Visao Geral

**Tema:** Módulo 17 - Governança
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 17 - Governança**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que é Governança de TI
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que é Governança de TI corretamente | Implementa mas com falhas | Implementacao robusta e completa |
