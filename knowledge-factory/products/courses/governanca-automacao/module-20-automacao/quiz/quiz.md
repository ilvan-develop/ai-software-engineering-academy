...
Qual é o conceito principal abordado em "Módulo 20 — Automação"?

- [ ] A) Resumo
- [ ] B) 1. O que é Automação
- [ ] C) Por que automatizar?
- [ ] D) Onde automatizar

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. O que é Automação", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "Por que automatizar?" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "Por que automatizar?" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar Onde automatizar, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. O que é Automação" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "20 - Automação" e assinale a alternativa que contém APENAS afirmações corretas:
