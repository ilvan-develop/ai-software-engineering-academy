...
- Compreender e aplicar conceitos de **Módulo 20 - Automação**
...
**Roteiro:**
1. 1. O que é Automação (15min)
2. 2. CI/CD — Pipelines de Integração e Deploy Contínuo (15min)
3. 3. Automação de Testes (15min)
4. 4. Automação de Infraestrutura — IaC (15min)
...
- Artigos complementares sobre Módulo 20 - Automação
