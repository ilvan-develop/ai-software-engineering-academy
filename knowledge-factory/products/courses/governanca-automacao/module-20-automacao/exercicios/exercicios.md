...
**Contexto:** Você acabou de estudar '20 - Automação' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. O que é Automação. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza Por que automatizar?. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '20 - Automação'

**Cenário:**
Você foi contratado para resolver um problema real usando Onde automatizar. O cliente espera uma solução bem documentada e testada.
