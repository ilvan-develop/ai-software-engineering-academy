# Projeto Pratico — Módulo 20 — Automação

---

## Visao Geral

**Tema:** Módulo 20 - Automação
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 20 - Automação**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. O que é Automação
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. O que é Automação corretamente | Implementa mas com falhas | Implementacao robusta e completa |
