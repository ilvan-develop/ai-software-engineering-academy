# Exercícios — Módulo 18 — Agentes de IA: Criação de Agentes Especializados

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '18 - Agentes de IA: Criação de Agentes Especializados' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Por que agentes especializados?. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza O problema do agente genérico. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '18 - Agentes de IA: Criação de Agentes Especializados'

**Cenário:**
Você foi contratado para resolver um problema real usando A solução dos agentes especializados. O cliente espera uma solução bem documentada e testada.
