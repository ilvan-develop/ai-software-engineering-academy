# Quiz — Módulo 18 — Agentes de IA: Criação de Agentes Especializados
...
Qual é o conceito principal abordado em "Módulo 18 — Agentes de IA: Criação de Agentes Especializados"?

- [ ] A) Resumo
- [ ] B) 1. Por que agentes especializados?
- [ ] C) O problema do agente genérico
- [ ] D) A solução dos agentes especializados

**Resposta correta:** B
**Explicação:** O conceito principal do módulo é "1. Por que agentes especializados?", que serve como fundamento para todo o conteúdo abordado.
**Nível:** Fácil
...
Qual das seguintes afirmações sobre "O problema do agente genérico" está correta?
...
**Resposta correta:** C
**Explicação:** O conceito de "O problema do agente genérico" é fundamental para a qualidade do software, conforme demonstrado ao longo do módulo.
**Nível:** Médio

## Pergunta 4 (Médio)

Ao implementar A solução dos agentes especializados, qual é a principal armadilha a ser evitada?
...
Qual a relação entre "1. Por que agentes especializados?" e os demais tópicos do módulo?
...
Analise as seguintes afirmações sobre "18 - Agentes de IA: Criação de Agentes Especializados" e assinale a alternativa que contém APENAS afirmações corretas:
