# Projeto Pratico — Módulo 18 — Agentes de IA: Criação de Agentes Especializados

---

## Visao Geral

**Tema:** Módulo 18 - Agentes de IA: Criação de Agentes Especializados
...
Voce foi contratado como arquiteto de software para construir um sistema enterprise que aplica os conceitos de **Módulo 18 - Agentes de IA: Criação de Agentes Especializados**. Este projeto simula um cenario real onde voce precisa tomar decisoes arquiteturais, implementar solucoes e documentar suas escolhas.
...
2. Deve implementar corretamente os conceitos de 1. Por que agentes especializados?
...
```
projeto-módulo-18---agentes-de-ia:-criação-de-agentes-especializados/
├── src/
...
|----------|------|-------------------|-----------------|-------------------|
| Correcao tecnica | 30% | Nao implementa 1. Por que agentes especializados? corretamente | Implementa mas com falhas | Implementacao robusta e completa |
