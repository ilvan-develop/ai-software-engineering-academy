# Exercícios — Módulo 19 — Auditorias

---

## Exercício 1 — Fácil: Verificação de Compreensão

**Contexto:** Você acabou de estudar '19 - Auditorias' e precisa verificar se entendeu os conceitos fundamentais.
...
**Contexto:** Seu time está implementando um sistema que envolve 1. Por que auditoria é o diferencial. Você precisa aplicar os conceitos do módulo para resolver um problema real.
...
**Contexto:** Você é o arquiteto responsável por um projeto que utiliza O que uma auditoria responde. Um colega propôs uma abordagem diferente da ensinada no módulo.
...
**Tema:** Implementar uma solução completa usando os conceitos de '19 - Auditorias'

**Cenário:**
Você foi contratado para resolver um problema real usando 2. O sistema de score (0-10). O cliente espera uma solução bem documentada e testada.
