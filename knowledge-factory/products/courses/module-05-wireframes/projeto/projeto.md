...
| Ferramenta | Para | Empresas que usam |
|------------|------|-------------------|
| **Figma (Enterprise)** | Design sistêmico, bibliotecas compartilhadas, handoff | Airbnb, Uber, Microsoft |
| **Abstract** | Versionamento + review de design (integrado com Git) | Shopify, Twitter |
| **Zeplin** | Handoff dev + specs automáticas | Google, Airbnb |
| **Avocode** | Inspect + export de assets | Netflix, Microsoft |
| **Storybook** | Documentação de componentes + wireframes vivos | IBM, BBC, Shopify |

> 💡 **No contexto enterprise, o wireframe é um artefato rastreável.** Ele deve responder: *Por que isso está aqui?*, *Qual user story gerou isso?*, *Quem aprovou?*

---

## Resumo

1. **Wireframes** são o esqueleto visual — estrutura sem polimento
2. **Baixa fidelidade** para divergir, **média** para validar, **alta** para documentar
3. **Wireframe ≠ Mockup ≠ Protótipo**: cada um tem seu propósito
4. **Grid, hierarquia e espaçamento** são os pilares de um bom layout
5. **Ferramentas**: papel para idear, Excalidraw/Balsamiq para rápido, Figma para enterprise
6. **Técnicas**: Crazy 8s, Grey Box, Wireflow, Sketching
7. **Anatomia**: header, hero, conteúdo, CTA, footer, navegação
8. **Estados**: loading, empty, error, success, disabled — sempre mapeie todos
9. **Validação**: clickable wireframe → teste com usuário → itere
10. **Enterprise**: documentação, versionamento, handoff, aprovações
